namespace Funzionale
{
    public static partial class StateAsyncExtensions
    {
        ...
        public static StateAsync<S, R> FlatMap<T, R, S>(this StateAsync<S, T> @this, Func<T, StateAsync<S, R>> map) =>
            new(state => @this.func(state).Map(x => map(x.value).func(x.state)).Unwrap());
        ...
        public static StateAsync<S, R> SelectMany<T, R, S>(this StateAsync<S, T> @this, Func<T, StateAsync<S, R>> map) => @this.FlatMap(map);

        public static StateAsync<S, V> SelectMany<T, R, V, S>(this StateAsync<S, T> @this, Func<T, StateAsync<S, R>> map, Func<T, R, V> project) =>
